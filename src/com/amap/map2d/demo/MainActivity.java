...
import com.amap.map2d.demo.location.LocationGPSActivity;
import com.amap.map2d.demo.location.LocationNetworkActivity;
import com.amap.map2d.demo.location.LocationSensorSourceActivity;
...
//					PoiAroundSearchActivity.class),
			...
			new DemoDetails(R.string.route_demo, R.string.route_description,
					RouteActivity.class),
			new DemoDetails(R.string.district_demo, R.string.district_description,
